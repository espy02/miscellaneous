bin_chars = {"a": "01100001", "b": "01100010", "c": "01100011", "d": "01100100", "e": "01100101", "f": "01100110",
...
for c in key:
    key_bin += bin_chars[c]
len_key_bin = len(key_bin)
key_bin += "0" * (512 - len_key_bin - 64)
size_bin = bin(len_key_bin)[2:]
key_bin += ("0" * (512 - len(key_bin) - len(size_bin))) + size_bin
print(key_bin)
